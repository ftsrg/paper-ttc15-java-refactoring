...
\item After every compilation unit was parsed, the previously populated caches are used to create the cross-references between the objects in the PG (\eg \ttcsf{TMember.access}).
\end{enumerate}
