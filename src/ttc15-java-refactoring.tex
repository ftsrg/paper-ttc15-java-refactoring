...
\item \ttcsf{ClassListTrace.} To express the collection of classes, a \ttcsf{ClassListTrace} object will identify them with their signatures joined by the \ttctt{\#} character. For example, a list of the \ttcsf{ChildClass1} and \ttcsf{ChildClass2} classes in the \ttcsf{example04} package have the \ttctt{Lexample04/ChildClass1;\#Lexample04/ChildClass2;} trace signature.
\end{itemize}
